		...
		<div class="container w-75 mt-5 mx-auto">
			...
			<ul class="list-group">
				<c:forEach var="news" items="${newslist}" varStatus="status">
					<li class="list-group-item list-group-item-aciton d-flex justify-content-between align-items-center">
			...
			<div class="collapse" id="addForm">
				<div class="card card-body">
					<form action="/news/news?action=addNews" method="get" enctype="multipart/form-data">
